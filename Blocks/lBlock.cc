...
lBlock::lBlock(const vector<vector<char>> &boardPtr) : Block(boardPtr)
{
    blockPos = {pair(3, 0), pair(3, 1), pair(3, 2), pair(2, 2)}; // starts on row 3 cuz the rows 0-2 are reserve rows
};
lBlock::~lBlock(){};
bool lBlock::clockwise()
{
    ...
    if (isVert && rightCorn)
    {
        if (boardPtr.playingBoard[llcCol][llcRow] != ' ' || boardPtr.playingBoard[llcCol + 2][llcRow] != ' ' || boardPtr.playingBoard[llcCol + 2][llcRow - 1] != ' ')
        {
            return false;
        }
    }
    ...
    {
        if (boardPtr.playingBoard[llcCol + 1][llcRow] != ' ' || boardPtr.playingBoard[llcCol + 1][llcRow - 2] != ' ' || boardPtr.playingBoard[llcCol][llcRow - 2] != ' ')
        {
            return false;
        }
    }
    ...
    {
        if (boardPtr.playingBoard[llcCol + 1][llcRow - 1] != ' ' || boardPtr.playingBoard[llcCol + 2][llcRow - 1] != ' ')
        {
            return false;
        }
    }
...
bool lBlock::counterClockwise()
{
    ...
    if (isVert && rightCorn)
    {
        if (boardPtr.playingBoard[llcCol][llcRow] != ' ' || boardPtr.playingBoard[llcCol][llcRow - 1] != ' ' || boardPtr.playingBoard[llcCol + 2][llcRow - 1] != ' ')
        {
            return false;
        }
    }
    ...
    {
        if (boardPtr.playingBoard[llcCol + 2][llcRow - 1] != ' ' || boardPtr.playingBoard[llcCol + 2][llcRow] != ' ')
        {
            return false;
        }
    }
    ...
    {
        if (boardPtr.playingBoard[llcCol][llcRow - 2] != ' ' || boardPtr.playingBoard[llcCol + 1][llcRow - 2] != ' ' || boardPtr.playingBoard[llcCol + 1][llcRow - 1] != ' ')
        {
            return false;
        }
    }
    ...
    {
        if (boardPtr.playingBoard[llcCol + 1][llcRow] != ' ' || boardPtr.playingBoard[llcCol][llcRow - 2] != ' ')
        {
            return false;
        }
    }
...
void lBlock::addBlock()
{
    for (int i = 0; i < blockPos.size(); ++i)
    {
        ...
        boardPtr.playingBoard[col][row] = 'L';
    }
};
bool lBlock::canCreate()
{
    for (int i = 0; i < blockPos.size(); ++i)
    {
        if (boardPtr.playingBoard[0][3] != ' ' || boardPtr.playingBoard[1][3] != ' ' || boardPtr.playingBoard[2][3] != ' ' || boardPtr.playingBoard[2][2] != ' ')
        {
            return false;
        }
    }
